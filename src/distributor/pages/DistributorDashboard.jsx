...
const DistributorDashboard = () => {
    ...
    const stats = [
        ...
        { label: 'Transactions', val: String(transactions.length), prefix: '', icon: Activity, iconColor: '#f59e0b', bg: '#fffbeb' },
        {
            ...
            prefix: '', icon: Users, iconColor: '#3b82f6', bg: '#eff6ff'
        },
    ];
                ...
                <div className="flex items-center justify-between mb-7">
                    <div>
                        ...
                        <span
                            ...
                            style={{ background: planCfg.accent }}
                        >
                            {planCfg.label}
                        </span>
                    </div>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-[1fr_340px] gap-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <motion.div
                            ...
                            className={`bg-gradient-to-br ${planCfg.color} rounded-2xl p-5 shadow-lg text-white relative overflow-hidden`}
                        >
