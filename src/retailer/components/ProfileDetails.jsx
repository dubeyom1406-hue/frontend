...
const ProfileDetails = ({ activeTab = 'personal' }) => {
    ...
    const handleSendOtp = async () => {
        ...
        try {
            ...
            alert(`Error sending OTP: ${error.message || "Connection refused"}. Please ensure the server is reachable.`);
        }
    };
    ...
    const handlePanVerify = async () => {
        ...
        try {
            ...
            alert(`Verification Failed: ${error.message}. Please check your connection and ensure the server is reachable.`);
        } finally {
